...
export default function MainLayout() {
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text-primary)] antialiased transition-colors duration-300">
      <div className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_10%_0%,var(--accent-soft),transparent_34%),radial-gradient(circle_at_100%_0%,rgba(20,184,166,0.14),transparent_25%)]" />
      <Navbar />
